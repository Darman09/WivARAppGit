<div id="modifyUser" class="modal">
	<div class="modal-content">
		<div class="row">
			...
			<div class="col s6">
				<label>Type d'utilisateur</label> <select required="required"
					class="browser-default" id="typeUserModify">
				</select>
			</div>
			<div class="col s6">
				<label>Espace Culturel Associé</label> <select
					class="browser-default" id="espaceCulturelUserModify">
			...
			<div class=" col s12">
				<label>Adresse mail</label> <input id="mailUserModify" type="text"
					class="validate" required="required">
			</div>
			<div class="col s12">
